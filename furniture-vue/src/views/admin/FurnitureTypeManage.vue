<template>
  <div class="manage-page">
    ...
    <div class="search-bar">
      <el-input v-model="searchForm.name" placeholder="类型名称" clearable style="width: 200px"
                @keyup.enter="handleSearch"/>
      <el-button type="primary" style="margin-left: 10px" @click="handleSearch">搜索</el-button>
      <el-button @click="resetSearch">重置</el-button>
      <el-button type="success" style="margin-left: auto" @click="handleAdd">+ 新增类型</el-button>
    </div>
    ...
    <div class="pagination">
      <el-pagination v-model:current-page="currentPage" v-model:page-size="pageSize"
                     ...
                     @size-change="handleSizeChange" @current-change="loadList"/>
    </div>
        ...
        <el-form-item label="图标" prop="icon">
          <div class="upload-container">
            ...
            <div class="upload-tip">
              ...
              <span v-else-if="formData.icon" class="tip-text">点击更换图标</span>
              <span v-else class="tip-text">点击上传图标</span>
            </div>
          </div>
          <el-input v-model="formData.icon" placeholder="图标URL" style="margin-top: 10px;"/>
        </el-form-item>
      </el-form>
      <template #footer>
