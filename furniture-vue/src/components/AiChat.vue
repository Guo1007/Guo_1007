      ...
      <div v-if="isOpen" class="chat-window" :style="chatWindowStyle">
        ...
        <div class="chat-header">
          ...
          <div class="header-actions">
            <el-icon class="action-icon" @click="newChat" title="新建会话">
              <Plus/>
            </el-icon>
            <el-icon class="action-icon" @click="clearChat" title="清空记录">
              <Delete/>
            </el-icon>
...
import {ChatDotRound, Close, Delete, Monitor, Plus, Promotion} from '@element-plus/icons-vue'
