...
-- ----------------------------
INSERT INTO `furniture` VALUES (1, '实木餐桌', 'https://gmc-1007.oss-cn-beijing.aliyuncs.com/furniture/2026/06/14/f242a16936f445d28a6a377cae588b7c.jpg', 4, 2580, '顾家', 44, '进口橡木，环保漆面，可容纳6-8人', 'https://gmc-1007.oss-cn-beijing.aliyuncs.com/furniture/2026/05/19/0653a0da39564c5985f30092c375a88a.jpg,https://gmc-1007.oss-cn-beijing.aliyuncs.com/furniture/2026/05/19/a1e71f6e73a44b23a4ecb363a32bf16c.jpg', '');
...
INSERT INTO `furniture` VALUES (6, '餐椅', 'https://gmc-1007.oss-cn-beijing.aliyuncs.com/furniture/2026/05/19/27f9fbb417c84c899f3ac82d94c071c2.jpg', 4, 380, '顾家', 49, '实木椅腿，皮质坐垫，四把一套', '', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '通知表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of notification
-- ----------------------------
INSERT INTO `notification` VALUES (1, NULL, '欢迎光临', '欢迎光临！！！', 'system', '2026-05-18 14:33:02');
INSERT INTO `notification` VALUES (10, NULL, '12', '12', 'system', '2026-05-21 00:11:09');
INSERT INTO `notification` VALUES (11, 1, '个人简历', '求职简历', 'system', '2026-05-23 18:12:00');
INSERT INTO `notification` VALUES (12, NULL, '简历', '简历', 'system', '2026-05-23 18:16:07');
INSERT INTO `notification` VALUES (13, NULL, '12', '12', 'system', '2026-05-26 14:08:10');
...
CREATE TABLE `notification_read`  (
  ...
  INDEX `idx_user`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '通知已读记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2066824489049821186 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2066824489049821187 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
-- Records of review
-- ----------------------------
INSERT INTO `review` VALUES (2, 1, 2056279154531528705, 6, 5, '非常好，值得推荐！', '2026-05-18 17:55:34');
INSERT INTO `review` VALUES (3, 2, 2059155009276502018, 6, 3, '一般般', '2026-05-26 14:10:53');
...
CREATE TABLE `sku`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_furniture_id`(`furniture_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'SKU表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sku` VALUES (6, 6, 'SKU-6', 380.00, 49, NULL, 1, '2026-06-14 20:24:27');
...
INSERT INTO `sku` VALUES (21, 1, 'SF-B', 2580.00, 19, '', 1, '2026-06-15 10:06:51');
INSERT INTO `sku` VALUES (22, 1, 'SF-W', 3000.00, 25, '', 1, '2026-06-15 10:06:51');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'SKU与规格值关联表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sku_spec
-- ----------------------------
INSERT INTO `sku_spec` VALUES (5, 21, 4, 7);
INSERT INTO `sku_spec` VALUES (6, 22, 4, 8);
...
CREATE TABLE `spec_group`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_furniture_id`(`furniture_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '规格组表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of spec_group
-- ----------------------------
INSERT INTO `spec_group` VALUES (4, 1, '颜色', 2, '2026-06-15 10:06:51');
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '规格值表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of spec_value
-- ----------------------------
INSERT INTO `spec_value` VALUES (7, 4, '黑色', '', 0);
INSERT INTO `spec_value` VALUES (8, 4, '白色', '', 1);
...
INSERT INTO `user` VALUES (2, '13483005181', '3482439245@qq.com', '$2a$10$UJs8MLGk/NxxyxUiQsaR9.9Qs2I06NyIRvNTfAmM5oQyqYcKz.8H2', 'LOPS', '', '河北省邯郸市', '名称', '13483005181', '2026-03-23 18:39:56', 0);
...
INSERT INTO `user_address` VALUES (3, 1, '', '', '', 0, '2026-06-16 17:45:51');
INSERT INTO `user_address` VALUES (4, 1, '', '', '', 0, '2026-06-16 18:03:27');
INSERT INTO `user_address` VALUES (5, 1, '', '', '', 0, '2026-06-16 18:04:04');
INSERT INTO `user_address` VALUES (6, 1, '', '', '', 0, '2026-06-16 18:05:32');
