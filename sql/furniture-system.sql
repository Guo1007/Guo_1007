...
VALUES (1, 1, 2, '2026-05-18 17:12:09');
...
VALUES (1, NULL, '欢迎光临', '欢迎光临！！！', 'system', 1, '2026-05-18 14:33:02');
...
(
  ...
  AUTO_INCREMENT = 2056279154531528706
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2056279154531528707
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `user`
VALUES (1, '13483005180', '3102777566@qq.com', '$2a$10$qzs19TAWQKt8kqMVxCtBIeouKl0bn0PNIIoU4wfVDXFWKJcm582Di', 'LOPS',
        'https://gmc-1007.oss-cn-beijing.aliyuncs.com/avatar/2026/05/19/8fec59984ca34b06aa243b8be9a1cfe2.jpg',
        '河北省邯郸市永年区西苏乡北贾葛村', '郭名城', '13483005180', '2026-03-24 18:39:53', 1);
INSERT INTO `user`
VALUES (2, '13483005181', NULL, '$2a$10$UJs8MLGk/NxxyxUiQsaR9.9Qs2I06NyIRvNTfAmM5oQyqYcKz.8H2', 'user_MhdQvwWv8W', '',
        NULL, NULL, NULL, '2026-03-23 18:39:56', 0);
